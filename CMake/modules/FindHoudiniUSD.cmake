...
find_path(Houdini_USD_INCLUDE_DIR
    "pxr/pxr.h"
    PATHS ${HOUDINI_ROOT}
    PATH_SUFFIXES "agentkit/include"
    NO_DEFAULT_PATH)
...
foreach(python_major_minor "3;9" "3;7" "2;7")
    ...
    find_path(
        Houdini_Python_INCLUDE_DIR
            "pyconfig.h"
        PATHS ${HOUDINI_ROOT}/agentkit/include
        PATH_SUFFIXES
...
set(Python3_EXECUTABLE ${HYTHON_EXECUTABLE})
...
if(HoudiniUSD_FOUND AND NOT TARGET hd)
    ...
    target_include_directories(hboost INTERFACE ${Houdini_Python_INCLUDE_DIR} ${Houdini_USD_INCLUDE_DIR})
endif()
